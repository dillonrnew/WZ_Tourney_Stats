...
import "../../styles/Major Tournament Pages/QualifiersPage.css";
...
const buildQualifierTourneyName = (round, lobby) => `PCL ROUND ${round} LOBBY ${lobby}`;
const GROUP_STAGE_TOURNEY_LOOKUPS = [
  { nodeId: "w1ab", tournamentName: "WEEK 1 A VS B" },
  { nodeId: "w1bc", tournamentName: "WEEK 1 B VS C" },
  { nodeId: "w1ac", tournamentName: "WEEK 1 A VS C" },
  { nodeId: "w2ab", tournamentName: "WEEK 2 A VS B" },
  { nodeId: "w2bc", tournamentName: "WEEK 2 B VS C" },
  { nodeId: "w2ac", tournamentName: "WEEK 2 A VS C" },
];
...
function QualifiersPage({ initialSection = "qualifiers" }) {
  const { id } = useParams();
            ...
            <div className="qp-finals-board">
              <div className="qp-finals-mvp-card">
                <img
                  ...
                  src={`${HEADSHOT_BASE_URL}/${encodeURIComponent("GROMALOK")}.png`}
                  alt="GROMALOK"
                  onError={(event) => {
